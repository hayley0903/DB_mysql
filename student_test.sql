...
INSERT INTO `tb_school_info` VALUES (1,'우송고등학교','동구','대전광역시 동구 동대전로131번길 53','042-620-5200'),(2,'보문고등학교','동구','대전광역시 동구 우암로 57','042-620-6600'),(3,'대전여자고등학교','동구','대전광역시 동구 용운로1번길 28-37','042-630-5901'),(4,'명석고등학교','동구','대전광역시 동구 우암로 380','042-623-2111'),(5,'충남고등학교','서구','대전광역시 서구 문정로 171','042-488-8013'),(6,'서일여자고등학교','서구','대전광역시 서구 구봉산북로 22','042-540-7745');
...
/*!50001 VIEW `v_student_info` AS select `student`.`student_id` AS `student_id`,`student`.`student_name` AS `student_name`,`student`.`student_graduate_yn` AS `student_graduate_yn`,`school`.`school_name` AS `school_name`,`school`.`school_area` AS `school_area`,`school`.`school_addr` AS `school_addr`,`school`.`school_phone` AS `school_phone` from (`tb_student_info` `student` join `tb_school_info` `school` on((`student`.`school_id` = `school`.`school_id`))) */;
...
-- Dump completed on 2024-09-02 10:02:20
