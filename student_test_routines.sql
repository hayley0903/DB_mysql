...
--
-- Dumping events for database 'student_test'
--

--
-- Dumping routines for database 'student_test'
--
/*!50003 DROP FUNCTION IF EXISTS `fn_getScore` */;
